        ...
        Entity.newBuilder()
            .setKey(
                Key.newBuilder()
                    ...
                    .addPath(PathElement.newBuilder().setId(1234).setKind("monkey")))
            .putProperties("someString", Value.newBuilder().setStringValue("someValue").build())
            .build());
    entities.add(
        Entity.newBuilder()
            .setKey(
                Key.newBuilder()
                    .setPartitionId(
                        PartitionId.newBuilder()
                            .setProjectId("my-project")
                            .setNamespaceId("some-namespace"))
                    .addPath(PathElement.newBuilder().setName("SomeName").setKind("monkey")))
            .putProperties("someString", Value.newBuilder().setIntegerValue(100L).build())
            .putProperties(
                "someSubRecord",
                Value.newBuilder()
                    .setEntityValue(
                        Entity.newBuilder()
                            .putProperties(
                                "someSubFloat", Value.newBuilder().setDoubleValue(0.234).build()))
                    .build())
            .putProperties(
                "someArray",
                Value.newBuilder()
                    .setArrayValue(
                        ArrayValue.newBuilder()
                            .addValues(Value.newBuilder().setIntegerValue(1234L))
                            .addValues(Value.newBuilder().setIntegerValue(1234L))
                            .addValues(
                                Value.newBuilder()
                                    .setArrayValue(
                                        ArrayValue.newBuilder()
                                            .addValues(
                                                Value.newBuilder()
                                                    .setStringValue(
                                                        "Some nested string in a nested array"))))
                            .build())
                    .build())
            .build());
                      ...
                      .setKey(
                          Key.newBuilder()
                              .setPartitionId(
                                  PartitionId.newBuilder()
                                      .setNamespaceId(
                                          entity.getKey().getPartitionId().getNamespaceId())
                                      .build())
