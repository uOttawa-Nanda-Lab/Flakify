...
import com.marcosbarbero.tests.Bucket4jInfinispanApplication;
...
public class Bucket4jInfinispanApplicationTestIT {
    ...
    @Test
    public void testBucket4jInfinispanRateLimiter() {
        assertTrue("bucket4jInfinispanRateLimiter", rateLimiter instanceof Bucket4jInfinispanRateLimiter);
    }
    ...
    public void testExceedingCapacity() throws InterruptedException {
        ...
        assertNotEquals(Bucket4jInfinispanApplication.ServiceController.RESPONSE_BODY, response.getBody());
