...
public class TestJsMinProcessor {
  ...
  @Test
  public void shouldHandleSlashAndIsolatedSingleQuoteInRegexes()
      throws Exception {
  ...
  @Test
  public void shouldNotMinifyInsideQuasiLiterals()
      throws Exception {
    assertEquals("\nvar a=`x = y`;", jsmin("var a = `x = y`;"));
  }
  ...
  @Test
  public void shouldNotRemoveLineBreakBeforeExclamationMark()
      throws Exception {
    assertEquals("\nvar a=1\n!true\nconsole.log(a)", jsmin("var a = 1\n!true\nconsole.log(a)"));
  }
  
  @Test
  public void shouldNotRemoveLineBreakBeforeTilde()
      throws Exception {
    assertEquals("\nvar a=1\n~true\nconsole.log(a)", jsmin("var a = 1\n~true\nconsole.log(a)"));
  }
  ...
  @Test
  public void shouldNotRemoveSpaceBetweenMinusSigns()
      throws Exception {
    assertEquals("\nconsole.log(1\n- -1)", jsmin("console.log(1\n- -1)"));
  }
  ...
  public void shouldRemoveInlineComments()
      throws Exception {
    assertEquals("\nvar r=1;", jsmin("var r = 1; // some comment"));
  }
  
  @Test
  public void shouldRemoveBlockComments()
      throws Exception {
    assertEquals("\nvar r=1;", jsmin("var r = 1; /* some comment */"));
  }
  
  @Test
  public void shouldNotProcessRegexpAfterOperator()
      throws Exception {
    assertEquals("\n1+/a  a/;", jsmin("1 + /a  a/;"));
    assertEquals("\n1-/a  a/;", jsmin("1 - /a  a/;"));
    assertEquals("\n1* /a  a/;", jsmin("1 * /a  a/;"));
  ...
  @Test
  public void shouldProcessRegexpContainingCurlyBraces()
      throws Exception {
  ...
  @Test
  public void shouldProcessRegexpContainingSemicolumn()
      throws Exception {
    assertEquals("\nreturn/a;/.test(s);", jsmin("return /a;/.test(s);"));
  }
  
  @Test(expected = Exception.class)
  public void shouldFailOnInlineCommentAfterUnclosedRegexp()
      throws Exception {
  ...
  @Test(expected = Exception.class)
  public void shouldFailOnUnclosedBlockCommentAfterUnclosedRegexp()
      throws Exception {
