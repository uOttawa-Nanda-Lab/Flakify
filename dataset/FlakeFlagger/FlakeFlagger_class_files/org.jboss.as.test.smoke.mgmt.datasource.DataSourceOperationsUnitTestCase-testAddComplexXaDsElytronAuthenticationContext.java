...
public class DataSourceOperationsUnitTestCase extends DsMgmtTestBase {
    ...
    @Test public void testAddComplexXaDsElytronAuthenticationContext() throws Exception{testAddComplexXaDs(ConnectionSecurityType.ELYTRON_AUTHENTICATION_CONTEXT);}
}
