...
public class RequestDumpingHandlerTestCase {
	 ...
	 */@Test @OperateOnDeployment(DEPLOYMENT_DUMP) public void testReqDumpHandlerOn(@ArquillianResource URL url) throws Exception{new RequestDumpingHandlerTestImpl.HttpRequestDumpingHandlerTestImpl(url.toURI(),logFilePath,true);}
