...
public class ContextImplTest {
	 ...
	 */@Test public void testGetReaderEnforcingOfCorrectEncoding() throws Exception{context.init(httpServletRequest,httpServletResponse);context.getReader();verify(httpServletRequest).setCharacterEncoding(anyString());}
