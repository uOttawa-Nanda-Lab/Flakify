...
public class ComparatorBasedComparisonStrategy_isGreaterThanOrEqualTo_Test extends AbstractTest_ComparatorBasedComparisonStrategy {
  ...
  @Test public void should_fail_if_a_parameter_is_not_comparable(){thrown.expect(ClassCastException.class);caseInsensitiveComparisonStrategy.isGreaterThanOrEqualTo(new Rectangle(),new Rectangle());}
