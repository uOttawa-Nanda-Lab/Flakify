...
public final class JobAPIFactoryTest extends AbstractEmbedZookeeperBaseTest {
    ...
    @Test public void assertCreateJobOperateAPI(){assertThat(JobAPIFactory.createJobOperateAPI(getConnectionString(),"namespace",Optional.<String>absent()),instanceOf(JobOperateAPI.class));}
}
