...
public class VerifyDatabaseOperationsTest extends PluggableActivitiTestCase {
  ...
  public void testExlusiveGateway() {
	...
	assertDatabaseInserts("StartProcessInstanceCmd", "HistoricActivityInstanceEntityImpl-bulk-with-5", 1L,
			"HistoricProcessInstanceEntityImpl", 1L, "HistoricVariableInstanceEntityImpl", 1L);
