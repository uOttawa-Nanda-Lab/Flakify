...
public class Objects_assertIsIn_with_Iterable_Test extends ObjectsBaseTest {
  ...
  @Test public void should_throw_error_if_Iterable_is_null(){thrown.expectNullPointerException(iterableIsNull());Iterable<String> c=null;objects.assertIsIn(someInfo(),"Yoda",c);}
}
