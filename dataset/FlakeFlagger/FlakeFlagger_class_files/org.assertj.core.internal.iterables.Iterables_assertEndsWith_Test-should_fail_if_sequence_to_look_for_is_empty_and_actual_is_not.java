...
public class Iterables_assertEndsWith_Test extends IterablesBaseTest {
  ...
  @Test public void should_fail_if_sequence_to_look_for_is_empty_and_actual_is_not(){thrown.expect(AssertionError.class);iterables.assertEndsWith(someInfo(),actual,emptyArray());}
