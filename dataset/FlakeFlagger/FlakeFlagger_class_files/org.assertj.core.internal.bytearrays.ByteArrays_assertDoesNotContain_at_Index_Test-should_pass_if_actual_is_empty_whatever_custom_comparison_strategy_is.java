...
public class ByteArrays_assertDoesNotContain_at_Index_Test extends ByteArraysBaseTest {
  ...
  @Test public void should_pass_if_actual_is_empty_whatever_custom_comparison_strategy_is(){arraysWithCustomComparisonStrategy.assertDoesNotContain(someInfo(),emptyArray(),(byte)-8,someIndex());}
}
