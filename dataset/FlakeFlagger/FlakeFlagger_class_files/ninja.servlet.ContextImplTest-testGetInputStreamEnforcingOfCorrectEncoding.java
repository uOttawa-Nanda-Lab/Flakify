...
public class ContextImplTest {
	 ...
	 */@Test public void testGetInputStreamEnforcingOfCorrectEncoding() throws Exception{context.init(httpServletRequest,httpServletResponse);context.getInputStream();verify(httpServletRequest).setCharacterEncoding(anyString());}
