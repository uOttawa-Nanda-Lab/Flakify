...
public class BooleanArrays_assertContainsExactly_Test extends BooleanArraysBaseTest {
  ...
  @Test public void should_throw_error_if_array_of_values_to_look_for_is_null(){thrown.expectNullPointerException(valuesToLookForIsNull());arrays.assertContainsExactly(someInfo(),actual,null);}
