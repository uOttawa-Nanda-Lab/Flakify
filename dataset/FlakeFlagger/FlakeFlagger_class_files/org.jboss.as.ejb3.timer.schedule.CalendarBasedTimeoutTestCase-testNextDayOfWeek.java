...
//    private static Logger logger = Logger.getLogger(CalendarBasedTimeoutTestCase.class);
	 ...
	 */@Test public void testNextDayOfWeek(){testNextDayOfWeek(new GregorianCalendar(2014,2,22,4,0,0).getTime());testNextDayOfWeek(new GregorianCalendar(2014,2,25,2,0,0).getTime());}
