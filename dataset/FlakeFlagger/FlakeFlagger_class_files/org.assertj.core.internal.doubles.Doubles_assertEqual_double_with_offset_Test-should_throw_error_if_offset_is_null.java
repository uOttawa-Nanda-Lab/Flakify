...
public class Doubles_assertEqual_double_with_offset_Test extends DoublesBaseTest {
  ...
  @Test public void should_throw_error_if_offset_is_null(){thrown.expectNullPointerException(offsetIsNull());doubles.assertEqual(someInfo(),new Double(8d),8d,null);}
}
