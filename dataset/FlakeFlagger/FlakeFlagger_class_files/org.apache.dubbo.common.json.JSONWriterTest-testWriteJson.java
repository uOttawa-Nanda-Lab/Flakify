...
public class JSONWriterTest extends TestCase {
    public void testWriteJson() throws Exception {
		...
		w.getBuffer().setLength(0);
		writer.objectBegin().objectItem("type").valueString("org.apache.dubbo.TestService").objectItem("version")
		...
		writer.objectItem("list").arrayBegin().valueNull().valueBoolean(false).valueInt(16).valueString("stri'''ng")
				.arrayEnd();
		writer.objectItem("service").objectBegin().objectItem("type").valueString("org.apache.dubbo.TestService")
