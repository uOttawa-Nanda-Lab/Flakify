...
public class TestFilter extends HBaseTestCase {
  ...
  public void testColumnPaginationFilter() throws Exception {
	...
	KeyValue[] expectedKVs2 = { new KeyValue(ROWS_ONE[0], FAMILIES[0], QUALIFIERS_ONE[3], VALUES[0]),
	...
	KeyValue[] expectedKVs3 = { new KeyValue(ROWS_ONE[0], FAMILIES[0], QUALIFIERS_ONE[3], VALUES[0]),
