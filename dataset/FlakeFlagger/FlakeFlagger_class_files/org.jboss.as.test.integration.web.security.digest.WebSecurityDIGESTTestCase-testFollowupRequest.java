...
public class WebSecurityDIGESTTestCase extends WebSecurityPasswordBasedBase {
	 ...
	 * @param url
	 * @throws Exception
	 */@OperateOnDeployment(DEPLOYMENT) @Test public void testFollowupRequest(@ArquillianResource URL url) throws Exception{makeCallFollowup(WebSecurityDigestSecurityDomainSetup.GOOD_USER_NAME,WebSecurityDigestSecurityDomainSetup.GOOD_USER_PASSWORD,HTTP_OK,true);}
