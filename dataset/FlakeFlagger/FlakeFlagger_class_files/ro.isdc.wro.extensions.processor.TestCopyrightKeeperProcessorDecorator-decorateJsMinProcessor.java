...
public class TestCopyrightKeeperProcessorDecorator {
  ...
  @Test public void decorateJsMinProcessor() throws Exception{final URL url=getClass().getResource("copyright");final File testFolder=new File(url.getFile(),"test");final File expectedFolder=new File(url.getFile(),"expected");WroTestUtils.compareFromDifferentFoldersByExtension(testFolder,expectedFolder,"js",processor);}
}
