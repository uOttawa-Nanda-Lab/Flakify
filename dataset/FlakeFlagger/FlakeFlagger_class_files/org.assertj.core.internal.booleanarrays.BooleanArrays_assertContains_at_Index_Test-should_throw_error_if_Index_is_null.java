...
public class BooleanArrays_assertContains_at_Index_Test extends BooleanArraysBaseTest {
  ...
  @Test public void should_throw_error_if_Index_is_null(){thrown.expectNullPointerException("Index should not be null");arrays.assertContains(someInfo(),actual,true,null);}
}
