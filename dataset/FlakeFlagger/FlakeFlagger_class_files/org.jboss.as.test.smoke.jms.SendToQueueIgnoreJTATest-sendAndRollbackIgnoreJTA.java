...
public class SendToQueueIgnoreJTATest {
	 ...
	 */@Test public void sendAndRollbackIgnoreJTA() throws Exception{sender.send(true,true);latch.await(MAX_WAIT_IN_SECONDS,SECONDS);assertEquals(0,latch.getCount());}
