...
public class CallActivityTest extends ResourceActivitiTestCase {
    ...
    public void testInstantiateSuspendedProcessByMessage() throws Exception {
		...
		Deployment messageTriggeredBpmnDeployment = processEngine.getRepositoryService().createDeployment()
		...
		try {
			ProcessInstance childProcessInstance = runtimeService
					.startProcessInstanceByMessage("TRIGGER_PROCESS_MESSAGE");
